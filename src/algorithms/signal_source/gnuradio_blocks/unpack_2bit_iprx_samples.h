/*!
 * \file unpack_2bit_iprx_samples.h
 *
...
#ifndef GNSS_SDR_UNPACK_2BIT_IPRX_SAMPLES_H
#define GNSS_SDR_UNPACK_2BIT_IPRX_SAMPLES_H

#include <cstdint>
#include <gnuradio/sync_interpolator.h>


class unpack_2bit_iprx_samples;

typedef boost::shared_ptr<unpack_2bit_iprx_samples> unpack_2bit_iprx_samples_sptr;
 ...
 */
class unpack_2bit_iprx_samples: public gr::sync_interpolator
{
private:
    friend unpack_2bit_iprx_samples_sptr
           make_unpack_2bit_iprx_samples_sptr( bool big_endian_bytes, 
                                          size_t item_size,
                                          bool big_endian_items,
...
public:
    unpack_2bit_iprx_samples( bool big_endianBytes,
                         size_t item_size,
                         bool big_endian_items,
                         bool reverse_interleaving );

    ~unpack_2bit_iprx_samples();
