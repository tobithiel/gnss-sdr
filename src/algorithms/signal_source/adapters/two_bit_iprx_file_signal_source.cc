/*!
 * \file two_bit_iprx_file_signal_source.cc
...
#include "two_bit_iprx_file_signal_source.h"
#include <cstdlib>
#include <exception>
#include <fstream>
#include <iomanip>
...
TwoBitIprxFileSignalSource::TwoBitIprxFileSignalSource(ConfigurationInterface* configuration,
                        ...
                        role_(role), in_streams_(in_streams), out_streams_(out_streams), queue_(queue)
{
    ...
    try
    {
            ...
            unpack_samples_ = make_unpack_2bit_iprx_samples( big_endian_bytes_,
...
TwoBitIprxFileSignalSource::~TwoBitIprxFileSignalSource()
{}


void TwoBitIprxFileSignalSource::connect(gr::top_block_sptr top_block)
{
...
void TwoBitIprxFileSignalSource::disconnect(gr::top_block_sptr top_block)
{
    gr::basic_block_sptr left_block = file_source_;
    gr::basic_block_sptr right_block = unpack_samples_;
...
gr::basic_block_sptr TwoBitIprxFileSignalSource::get_left_block()
{
...
gr::basic_block_sptr TwoBitIprxFileSignalSource::get_right_block()
{
    return valve_;
}
