/*!
 * \file two_bit_iprx_file_signal_source.h
...
#ifndef GNSS_SDR_TWO_BIT_IPRX_FILE_SIGNAL_SOURCE_H_
#define GNSS_SDR_TWO_BIT_IPRX_FILE_SIGNAL_SOURCE_H_
 ...
 */
class TwoBitIprxFileSignalSource: public GNSSBlockInterface
{
public:
    TwoBitIprxFileSignalSource(ConfigurationInterface* configuration, std::string role,
            unsigned int in_streams, unsigned int out_streams,
            boost::shared_ptr<gr::msg_queue> queue);

    virtual ~TwoBitIprxFileSignalSource();
    std::string role()
    {
        return role_;
    }
    ...
    /*!
     * \brief Returns "Two_Bit_IPRX_Packed_File_Signal_Source".
     */
    std::string implementation()
    {
        return "Two_Bit_Iprx_File_Signal_Source";
    }
    size_t item_size()
    {
        return item_size_;
...
private:
    ...
    unpack_2bit_iprx_samples_sptr unpack_samples_;
...
#endif /*GNSS_SDR_TWO_BIT_IPRX_FILE_SIGNAL_SOURCE_H_*/
